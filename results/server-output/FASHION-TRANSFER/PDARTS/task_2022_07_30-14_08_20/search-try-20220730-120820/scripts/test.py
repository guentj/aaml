...
from model import NetworkFASHION as Network
...
parser.add_argument('--model_path', type=str, default='/home/storage/models/darts/search-try-20220624-152820/weights.pt', help='path of pretrained model')
