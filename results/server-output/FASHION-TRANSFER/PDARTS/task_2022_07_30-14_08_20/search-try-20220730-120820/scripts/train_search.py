...
def main(train_data, test_data, seed):
    best_test_acc = 0
...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        print(f"Clean Benchmark for 100% Dataset")
        x_train,y_train, x_test,y_test = getData("normal")
        custom_train = CustomDataset(x_train, y_train)
        custom_test = CustomDataset(x_test, y_test)
        acc = main(custom_train, custom_test, seed)
        end_time = time.time()
        ...
        #
        start_time = time.time()
        print(f"Clean Benchmark for 10% Dataset")
        x_train,y_train, x_test,y_test = getData("mini")
        custom_train = CustomDataset(x_train, y_train)
        custom_test = CustomDataset(x_test, y_test)
        acc = main(custom_train, custom_test, seed)
        end_time = time.time()
        ...
        #
        # BENCHMARK FOR POISONED FASHION-MNIST-10
        #
